# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-04-05 19:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('auth_type', models.IntegerField(choices=[(1, 'CAS')])),
                ('url', models.URLField()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='realm',
            field=models.ForeignKey(default='17a21472-c8ff-4fab-a8ce-56dfba40c423', on_delete=django.db.models.deletion.CASCADE, to='main.Realm'),
        ),
        migrations.AddField(
            model_name='group',
            name='organization',
        ...
        migrations.AddField(
            ...
            name='realm',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auth_methods', to='main.Realm'),
        ),
        migrations.AddField(
            model_name='user',
            name='auth_method',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.ExternalAuthentication'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AlterUniqueTogether(
            name='user',
            unique_together=set([('realm', 'username')]),
        ),
    ]

...
from api.authentication import get_cas_client
...
class OverrideCASBackend(CASBackend):

    def authenticate(self, request, ticket, service):
        """Verifies CAS ticket and gets or creates User object"""

        client = get_cas_client(service_url=service, server_url='http://cas:8000/cas/')
